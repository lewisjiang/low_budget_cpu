...
--               E:/SEU/vvd/COA2/CPU_2.0/CPU_2.0.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_sim_netlist.vhdl
...
begin
  ...
  qspo(1) <= \<const0>\;
  qspo(0) <= \<const0>\;
  spo(15 downto 3) <= \^spo\(15 downto 3);
  spo(2) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.dist_mem_gen_0_dist_mem_gen_v8_0_11_synth
     port map (
      a(7 downto 0) => a(7 downto 0),
      spo(14 downto 2) => \^spo\(15 downto 3),
      spo(1 downto 0) => \^spo\(1 downto 0)
    );
end STRUCTURE;
library IEEE;
